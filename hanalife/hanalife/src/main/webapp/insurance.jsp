				...
				<div class="top-header">
					<div class="container">
						...
						<div class="right-section pull-right">
							<a href="${ pageContext.request.contextPath }" class="phone"><img src="images/icon-phone.png" class="icon">+1 823 424 9134</a>
					...
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
								...
								<li class="menu-item"><a href="${ pageContext.request.contextPath }/resource.jsp">보험추천</a></li>
								<li class="menu-item"><a href="${ pageContext.request.contextPath }/contact.jsp">찾아오시는길</a></li>
							</ul> <!-- .menu -->
						</div> <!-- .main-navigation -->
