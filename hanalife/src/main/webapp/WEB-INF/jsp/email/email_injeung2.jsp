...
<body>
	...
	<section>
		...
		<form action="${ pageContext.request.contextPath }/join_injeung2/${ dice }" method="post">
 		<table>
 			<tr>
				<th>인증번호입력</th>
 	...
 	<div align="center" style="border:1px solid black; height: 400px; width: 750px;" id="div1">
			...
			<hr>
 			...
 			<form action="${ pageContext.request.contextPath }/join_injeung2/${ dice }" method="post" class="w3-container">
		 		<p>
				  <label>인증번호입력</label>
